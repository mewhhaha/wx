...
const BUILTIN_ROOT_COMMANDS: EditorCommandCompletionItem[] = [
  ...
  { label: "add", detail: "add file buffer" },
  { label: "new", detail: "new scratch buffer" },
  { label: "vnew", detail: "new vertical scratch split" },
  { label: "vsplit", detail: "split pane vertically (Ctrl-w v)" },
  { label: "hsplit", detail: "split pane horizontally (Ctrl-w s)" },
  { label: "close", detail: "close active pane" },
  { label: "only", detail: "keep only active pane (Ctrl-w o)" },
  { label: "buffer-next", detail: "next buffer in active pane (g n)" },
  { label: "buffer-prev", detail: "previous buffer in active pane (g p)" },
