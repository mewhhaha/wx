...
function buildSyntaxSelection(
  ...
  return mode === "expand"
    ? expandSyntaxSelection(currentTree.rootNode as SyntaxNodeLike, selection)
    : shrinkSyntaxSelection(currentTree.rootNode as SyntaxNodeLike, selection, activeOffset);
}
